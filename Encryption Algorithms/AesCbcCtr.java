...
class AesCbcCtr {
    ...
    private static void calculateTime(final String mode,File smallFile,File largeFile,Key key) throws Exception {
        ...
        endTime = System.nanoTime();
        System.out.println("Time to encrypt 10Mb file with "+modename+" = " + (double)(endTime - startTime) + " nanoseconds");
        ...
        endTime = System.nanoTime();
        System.out.println("Time to decrypt 1Kb file with "+modename+" = " + (double)(endTime - startTime) + " nanoseconds");
    ...
    private static Key generateAESKey128() throws NoSuchAlgorithmException {
